...
def main():
    ...
    st.markdown("Real-time monitoring and analysis of energy generation and consumption")
    ...
    if filtered_df['anomaly'].any():
        ...
        # Fix negative values for size parameter
        anomalies_fixed = anomalies.copy()
        anomalies_fixed['size_value'] = anomalies_fixed['energy_generated_kwh'].abs()  # Use absolute value
        anomalies_fixed['size_value'] = anomalies_fixed['size_value'].clip(lower=1)    # Ensure minimum size of 1
